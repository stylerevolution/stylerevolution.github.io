...
<p>
  <a href="{{site.baseurl}}/images/parisvlondon2.pdf">
		<img class="london" src="{{site.baseurl}}/images/parisvlondon-2.png" alt="Paris vs. London" width="30%">
	</a>
	</p>

	<ul>
		<li>All images of the <i>Gallery of Fashion</i> are from the collection of the <a href="http://www.smb.museum/home.html">Kunstbibliothek, Staatliche Museen zu Berlin</a>.</li>
		<li>All images of the <i>The Fashions of London and Paris:</i> are the author's own taken at the <a href="http://collections.britishart.yale.edu/vufind/Record/2029623">Yale Center for British Art</a>.</li>
	</ul>
