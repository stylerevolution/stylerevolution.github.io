...
<h1>Supporting a Revolution: Underpinnings or the lack thereof</h1>
  ...
  <div class="corsets">
    <h2>No More Underwear!</h2>
      <img src="{{ site.baseurl }}/images/jm/stays.png" alt="stays" width="50%"/>
     ...
     <img style="float: center; margin: 0px 5% 0px 5%; width: 90%;" src="{{ site.baseurl }}/images/jm/metalelasticcloseup.png" alt="metalelasticcloseup"/>
</div>
  
<div class="corsets">
    <h2>Corset styles</h2>
      <img style="float: left;" src="{{ site.baseurl }}/images/jm/lisbethcorset.png" alt="lisbethcorset" width="50%"/>
   <p><br>Inspiration changed quickly and was taken from whatever novelty was trending at the moment. Whether it was political, historical, or theatrical- nothing was off limits to influence women's dress. In this plate, we see the "Lisbeth corset" so named after Mme. Saint-Aubin, an actress who played the part of Lisbeth in a Favières and Grétry comic opera. </p><br>
       <img src="{{ site.baseurl }}/images/jm/bodice.png" alt="bodice" width="50%"/>  
      ...
      <img style="float: left;" src="{{ site.baseurl }}/images/jm/minervavest.png" alt="Minerva Vest" width="50%"/>
      <p>Soon, women's underpinnings began to migrate from underclothing to outer clothing. </p>
    </div>

    <div class="corsets">
     <h2>The Sexuality of Underwear</h2>
      <img src="{{ site.baseurl }}/images/jm/sprigs.jpg" alt="nocorsets" width="50%"/>
      ...
      <img style="float: left; margin: 0 5% 5% 5%;" src="{{ site.baseurl }}/images/jm/petticoatredux.png" alt="petticoatredux" width="50%"/>
